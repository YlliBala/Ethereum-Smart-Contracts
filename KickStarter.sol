pragma solidity ^0.4.22; contract KickStarter{
    ...
    /* Funksioni qe u mundeson te kontribojn kerkon qe minimumi te jet 
0.9Eth;
       Ka validim qe atyre qe kan kontribuar tu mundesoj te drejten per 
te votuar;
    */
    ...
    /*Funksioni qe mundeson per te votuar,
      ...
      Ka validim qe secili votues te kete te drejten te votoj vetem nje 
here.
    */
  function voto(bool _votaIme) public {
      require(kontribuesit[msg.sender].numri == 1 && 
kontribuesit[msg.sender].kaVotuar == false );
      
      kontribuesit[msg.sender].kaVotuar = true;
      
      Votat.push(_votaIme);
  }
    /*Eshte funksion qe kthen totalin e Eth qe jane mbledhur nga 
kontribimet
      Kthen shumen ne Eth;
  ...
  Perqindja kthehet ne formen e rrumbullaksuar duke mos i mare parasyshe 
numrat dhjetore;
  */
