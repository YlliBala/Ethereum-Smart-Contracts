...
contract BetBastFun{
    ...
    address private AdressaCoinit = 0x8c1ed7e19abaa9f23c476da86dc1577f1ef401f5;
    ...
    function TestTransfer(address _add) public  returns(bool){
    ...
    function BigTest () public view returns(address){
        return b.transfer1(msg.sender,5);
...
contract BetBast{
        ...
        function transfer1(address _to, uint256 _value) public returns (address);
